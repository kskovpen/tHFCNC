...
//	     vars[4] = HiggsEta_TOPTOPLEPHBB;
	     vars[3] = TopLepMass_TOPTOPLEPHBB;
	     vars[4] = TopLepMass_TOPTOPLEPHAD;
	     vars[5] = TopLepPt_TOPTOPLEPHBB;
//	     vars[8] = TopLepEta_TOPTOPLEPHBB;
	     vars[6] = HiggsBJet1HiggsBJet2Dr_TOPTOPLEPHBB;
	     vars[7] = TopLepHiggsDr_TOPTOPLEPHBB;
	     vars[8] = TopLepTopHadDr_TOPTOPLEPHAD;
...
//	     vars[8] = TopLepEta_TOPTOPLEPHBB;
   ...
   // b4j4 tH Hut vs ttbar
   else if( imva == 12 )
     {
	TFile* outfile = TFile::Open("TMVA_HutST_b4j4.root","RECREATE");
	...
	TMVA::Factory *factory = new TMVA::Factory("TMVA_HutST_b4j4",outfile,
						   "!V:!Silent:Color:DrawProgressBar:Transformations=I;D:AnalysisType=Classification" );
	...
	TChain tr_sig("tr_all_b4j4");
	tr_sig.Add("../histTEST_MERGED/ST_TH_1L3B.root");

	TChain tr_bkg("tr_all_b4j4");
	tr_bkg.Add("../histTEST_MERGED/TT_TuneCUETP8M1_13TeV-powheg-pythia8.root");
   ...
   // b4j4 tH Hct vs ttbar
   else if( imva == 13 )
     {
	TFile* outfile = TFile::Open("TMVA_HctST_b4j4.root","RECREATE");
	...
	TMVA::Factory *factory = new TMVA::Factory("TMVA_HctST_b4j4",outfile,
						   "!V:!Silent:Color:DrawProgressBar:Transformations=I;D:AnalysisType=Classification" );
   ...
   // b4j4 ttbar Hut vs ttbar
   else if( imva == 14 )
     {
	TFile* outfile = TFile::Open("TMVA_HutTT_b4j4.root","RECREATE");
...
//	double TopLepTopHadDr_TOPTOPLEPHAD;
	...
	TMVA::Factory *factory = new TMVA::Factory("TMVA_HutTT_b4j4",outfile,
						   "!V:!Silent:Color:DrawProgressBar:Transformations=I;D:AnalysisType=Classification" );
...
//	     vars[7] = TopLepPt_TOPTOPLEPHBB;
//	     vars[8] = TopLepEta_TOPTOPLEPHBB;
	     vars[2] = HiggsBJet1HiggsBJet2Dr_TOPTOPLEPHBB;
...
//	     vars[11] = TopLepTopHadDr_TOPTOPLEPHAD;
   ...
   // b4j4 ttbar Hct vs ttbar
   else if( imva == 15 )
     {
	TFile* outfile = TFile::Open("TMVA_HctTT_b4j4.root","RECREATE");
...
//	double TopLepTopHadDr_TOPTOPLEPHAD;
	...
	TMVA::Factory *factory = new TMVA::Factory("TMVA_HctTT_b4j4",outfile,
						   "!V:!Silent:Color:DrawProgressBar:Transformations=I;D:AnalysisType=Classification" );
