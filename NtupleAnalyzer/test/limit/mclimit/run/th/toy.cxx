...
{  
   ...
   h_signal[0] = h_ch1_signal;
   h_signal_sys_jesUp[0] = h_ch1_signal_sys_jesUp;
   h_signal_sys_jesDown[0] = h_ch1_signal_sys_jesDown;

   h_signal[1] = h_ch2_signal;
   h_signal_sys_jesUp[1] = h_ch2_signal_sys_jesUp;
   h_signal_sys_jesDown[1] = h_ch2_signal_sys_jesDown;
   
   h_background[0] = h_ch1_background;
   h_background_sys_jesUp[0] = h_ch1_background_sys_jesUp;
   h_background_sys_jesDown[0] = h_ch1_background_sys_jesDown;

   h_background[1] = h_ch2_background;
   h_background_sys_jesUp[1] = h_ch2_background_sys_jesUp;
   h_background_sys_jesDown[1] = h_ch2_background_sys_jesDown;
...
//   int npe = 10000;
   ...
   int bayf = 2; // 1 - Heinrich, 2 - Markov chains
